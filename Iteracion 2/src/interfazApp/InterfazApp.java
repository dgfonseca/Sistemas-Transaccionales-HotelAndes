...
public class InterfazApp extends JFrame implements ActionListener
{
	...
	public void adicionarReserva()
	{
		try
		{
			...
			if(id != null)
			{
				...
				String a�o=JOptionPane.showInputDialog(this,"a�o de la reserva");
				...
				String ini=a�o+mes+dia;				
				String a�o2=JOptionPane.showInputDialog(this,"a�o de fin de la reserva");
	...
	public void adicionarServicio()
	{
		try
		{
			...
			if(id != null)
			{
				...
				String a�o=JOptionPane.showInputDialog(this,"hora de apertura servicio ej 22");
				String mes=JOptionPane.showInputDialog(this,"Minuto de aprtura del servicio ej 05");
				String fechaInicio=a�o+mes;        		
				String a�o2=JOptionPane.showInputDialog(this,"hora de cierre servicio ej 22");
				String mes2=JOptionPane.showInputDialog(this,"Minuto de cierre del servicio ej 05");
				String fini=a�o2+mes2;        		        		
				String descripcion = JOptionPane.showInputDialog(this, "Descripcion");
	...
	public void adicionarSirven()
	{
		try
		{
			...
			String a�o=JOptionPane.showInputDialog(this,"a�o de uso del servicio");
